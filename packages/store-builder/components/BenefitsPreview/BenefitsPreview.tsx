...
const benefits = [
  {
    title: "Team Approved",
    description: "All items meet team requirements",
    icon: LuShieldCheck,
  },
  {
    title: "Quality Gear",
    description: "Premium brands you trust",
    icon: LuUserRound,
  },
  {
    title: "Easy Returns",
...
export default function BenefitsPreview({ brandColor }: BenefitsPreviewProps) {
  return (

...
import type { ArtworkSurfaceTone } from "../../lib/artworkContrast";
import type { DecorationPreviewBounds, DecorationProfileId, ProductArtworkPlacement } from "../../lib/decorationProfiles";

...
export default function OrganizationLogoUpload({
  ...
  const hasLogo = Boolean(logoFile || logoPreviewUrl);
        ...
        <div className={`${styles.upload} ${styles.uploadWithLogo}`}>
          <div className={styles.logoPreviewRow}>
            ...
            <div className={styles.logoDetails}>
              <h3>{logoFile ? logoFile.name : "Current organization logo"}</h3>

              <p>{logoFile && logoExtension && logoSize ? `${logoExtension} • ${logoSize}` : "Saved to your store"}</p>

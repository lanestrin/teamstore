...
export default function OrganizationStep() {
  ...
  const logoExtension = storeDraft.logoFile
    ? storeDraft.logoFile.name.split(".").pop()?.toUpperCase()
    : null;
      ...
      <div className={styles.form}>
        ...
        <div className={formStyles.field}>
          ...
          <div className={styles.slug}>
            <strong>
              teamstore.com/store/
              {storeDraft.organizationSlug || "your-organization"}/
              {storeDraft.storeSlug || "your-store-name"}
            </strong>
          </div>

          <p className={styles.helper}>
            Your store address is generated automatically from the organization
            and store names.
          </p>
        </div>
              ...
              <div className={styles.logoPreviewRow}>
                <div className={styles.logoPreview}>
                  {logoPreviewUrl && (
                    <img
                      src={logoPreviewUrl}
                      alt={`${storeDraft.organizationName || "Organization"} logo preview`}
                    />
                  )}
                </div>

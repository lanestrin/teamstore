...
export default function AuthForm() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (message.includes("invalid password")) {
        setError(mode === "signUp" ? `Password must be at least ${MIN_PASSWORD_LENGTH} characters.` : "Incorrect email or password.");
      } else {
  ...
  return (
    <div className={styles.card}>
      ...
      <p className={styles.subtitle}>{isSignUp ? "Create an account to manage your stores." : "Sign in to manage your stores."}</p>
